...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        # Fix CUDA 12.9+ CCCL ABI namespace macro incompatibility with PCL's legacy FindCUDA
        # -Xcompiler=-fPIC: PCL GPU 用旧版 FindCUDA 宏，nvcc 不转发 CMAKE_CXX_FLAGS 的 -fPIC，
        # 导致 .a 中的 .o 缺少 PIC 重定位，无法链接进共享库
        "-DCMAKE_CUDA_FLAGS=-DTHRUST_DISABLE_ABI_NAMESPACE -DTHRUST_IGNORE_ABI_NAMESPACE_ERROR -DCUB_DISABLE_NAMESPACE_MAGIC -DCUB_IGNORE_NAMESPACE_MAGIC_ERROR -Xcompiler=-fPIC"
        # WITH
        -DWITH_DAVIDSDK=OFF
        -DWITH_DOCS=OFF
        -DWITH_DSSDK=OFF
